# Contributing to greedy-find

Thanks for your interest in greedy-find. This document explains how to set up
the project locally, run the test suite, and submit a pull request.

## Reporting issues

Open an issue at
[`sachncs/greedy-find/issues`](https://github.com/sachncs/greedy-find/issues)
